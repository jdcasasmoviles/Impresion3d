...
<html>
    ...
    <section>
    <table width="730" border="0" align="center" cellpadding="0" cellspacing="0" id="preview">
    <tr>
        <td scope="col">&nbsp;</td>
    </tr>
    <tr>
	<td scope="col">
            <table border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td scope="col"><img src="/Impresion3d/img/catalogo.jpg" alt="Photography templates" width="700" height="400"/></td>
                </tr>
            </table>
        </td>
    </tr>
